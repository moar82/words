...
public interface FlashcardDataStore {
    ...
    Observable<Void> removeFlashcard(Long flashcardEntityId);

    Observable<Void> bulkInsertFlashcards(List<FlashcardEntity> flashcardEntityList);

    Observable<FlashcardEntity> getFlashcardById(Long flashcardId);
