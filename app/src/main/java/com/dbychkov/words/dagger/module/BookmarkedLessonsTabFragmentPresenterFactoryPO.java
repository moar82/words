...
public class BookmarkedLessonsTabFragmentPresenterFactoryPO {
    ...
    public BookmarkedLessonsTabFragmentPresenterFactoryPO(ActivityModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<LessonRepository> lessonRepositoryProvider, Provider<RxEventBus> rxEventBusProvider) {
        this.module = module;
