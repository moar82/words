...
public class ActivityModule_ViewFlashcardsActivityPresenterFactoryCreatePO {
    ...
    public ActivityModule_ViewFlashcardsActivityPresenterFactoryCreatePO(ActivityModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<FlashcardRepository> flashcardRepositoryProvider, Provider<SpeechService> speechServiceProvider) {
        this.module = module;
