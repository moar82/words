...
public class ActivityModule_UserLessonsTabFragmentPresenterFactoryCreatePO {
    ...
    public ActivityModule_UserLessonsTabFragmentPresenterFactoryCreatePO(ActivityModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<LessonRepository> lessonRepositoryProvider, Provider<RxEventBus> rxEventBusProvider) {
        this.module = module;
