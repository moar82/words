...
public class EditFlashcardsActivityPresenterFactoryPO {
    ...
    public EditFlashcardsActivityPresenterFactoryPO(ActivityModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<FlashcardRepository> flashcardRepositoryProvider, Provider<SpeechService> speechServiceProvider) {
        this.module = module;
