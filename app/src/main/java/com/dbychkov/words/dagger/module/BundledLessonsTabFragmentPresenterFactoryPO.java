...
public class BundledLessonsTabFragmentPresenterFactoryPO {
    ...
    public BundledLessonsTabFragmentPresenterFactoryPO(ActivityModule module, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<LessonRepository> lessonRepositoryProvider, Provider<RxEventBus> rxEventBusProvider) {
        this.module = module;
