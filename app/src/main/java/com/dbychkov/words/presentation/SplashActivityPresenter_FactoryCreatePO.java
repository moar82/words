...
public class SplashActivityPresenter_FactoryCreatePO {
    ...
    public SplashActivityPresenter_FactoryCreatePO(MembersInjector<SplashActivityPresenter> membersInjector, Provider<ThreadExecutor> threadExecutorProvider, Provider<PostExecutionThread> postExecutionThreadProvider, Provider<LessonsImporter> lessonImporterProvider, Provider<Context> contextProvider) {
