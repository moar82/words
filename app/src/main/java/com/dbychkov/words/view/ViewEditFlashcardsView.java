...
public interface ViewEditFlashcardsView {
    ...
    void renderEditableFlashcards(List<Flashcard> flashcardList);

    void setupFab(Boolean editable);

    void renderProgress(Integer renderProgress);

    void renderRemovedFlashcard(Flashcard flashcard, int position);

    void renderOnRemoveSnackBar(Flashcard flashcard, final int position);
}
